function updateSurahs() {
    ...
    var surahField = document.getElementById("id_surah");
    var surahOptions = {
    ...
    surahField.innerHTML = '';
    if (category in surahOptions) {
        surahOptions[category].forEach(function(surah) {
            var option = document.createElement("option");
            option.value = surah;
            option.text = surah;
            surahField.add(option);
        });
    }
}

function updateAyahs() {
    var surah = document.getElementById("id_surah").value;
    var ayahField = document.getElementById("id_ayah_count");
    var ayahOptions = {
        "الفاتحة": 7,
            "النساء": 176,
            "المائدة": 120,
            ...
            "البقرة": 286,
            "آل عمران": 200,
        // Add all other Surahs with their corresponding Ayah counts here...
    };

    if (surah in ayahOptions) {
        ayahField.value = ayahOptions[surah];
    } else {
        ayahField.value = '';
    }
}

document.getElementById("id_category").addEventListener("change", updateSurahs);
document.getElementById("id_surah").addEventListener("change", updateAyahs);
